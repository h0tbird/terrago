...
// as the receiving tfd.Diagnostics.
//
// This conversion preserves the data that HCL diagnostics are able to
// preserve but would be lossy in a round trip from tfd to HCL and then
// back to tfd, because it will lose the specific type information of
